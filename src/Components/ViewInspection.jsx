      ...
      <div className="mt-8 mr-8 mb-8">
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} className="mt-8">
            ...
            <RichTextEditor
              content={values.preInspectionReport}
              themeMode={themeMode}
              disabled={true}
            />
          </Grid>
          ...
          <Grid item xs={12} className="mt-8">
            ...
            <RichTextEditor
              content={values.postInspectionReport}
              themeMode={themeMode}
              disabled={true}
            />
          </Grid>
        ...
        {data.fields.map((value, index) => {
          return (
            <Grid
              item
              xs={12}
              className="border border-black  border-2 flex flex-row justify-between items-center font-qanelasRegular text-[20px] text-black dark:text-white dark:border-white"
            >
